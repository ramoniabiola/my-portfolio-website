import { EmailOutlined, Facebook, Instagram, LinkedIn, LocationOnOutlined, PhoneCallbackOutlined, X } from '@mui/icons-material'
    ...
    return (
        <div className='relative w-full h-screen flex flex-col items-center justify-start bg-gradient-to-l from-emerald-300 to-emerald-950 rounded-tl-[12rem] rounded-tr-[12rem] overflow-y-visible'>
            ...
            <div className='w-full flex flex-col items-center justify-start'>
                ...
                <div className='w-4/5 flex items-start justify-center mb-40 space-x-96'>
                    ...
                    <div className='flex-1 flex flex-col items-center justify-center'>
                        <form className='flex flex-col items-center justify-center w-full h-full space-y-3 p-8 bg-gradient-to-r from-emerald-300 to-emerald-500 shadow-xl opacity-95 rounded-2xl'>
                            ...
                            <button className='bg-gray-950 p-4 w-1/2 rounded-[0.60rem] text-xl font-bold text-white'>Send</button>
                        </form>
                    </div>
                </div>
                <div className='w-full flex flex-col items-center justify-center space-y-6'>
                    ...
                    <div className='w-4/5 flex items-center justify-between'>
                        ...
                        <div className='flex space-x-5 cursor-pointer'>
                            ...
                            <span className='p-4 bg-gradient-to-r from-emerald-300 to-emerald-700 shadow-2xl opacity-90 rounded-xl'><Instagram style={{ color: 'white'}} /></span>
