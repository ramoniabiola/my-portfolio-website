...
export const Services = () => {
    ...
    return (
        <div className='w-11/12 md:w-4/5 h-auto mt-96 md:mt-32 flex flex-col items-top justify-center mx-auto my-auto'>
                ...
                <div className='services1 flex flex-col md:flex-row items-top justify-center mt-10 mb-56 space-y-40 md:space-y-0 md:space-x-40'>
                    <div className='md:flex-1 max-w-xl rounded-xl shadow-lg p-6 bg-inherit border-8 border-double border-emerald-500  text-white'
                        ...
                        <div className='flex items-center justify-start mt-4 mb-10'>
                            <span className='p-3 md:p-4 bg-white rounded-full'><CodeOffRounded className="text-5xl md:text-[42px] text-emerald-400" /></span>
                            <h1 className='ml-4 md:ml-6 text-3xl md:text-4xl font-semibold text-white'>Front-End Development</h1>
                        </div>
                        <p className='break-words mb-4 text-gray-400 text-base md:text-lg leading-8'>
                    ...
                    <div className='md:flex-1 max-w-xl rounded-xl p-6 bg-inherit border-8 border-emerald-500 border-double text-white'
                        style={{ boxShadow: '0 0 50px 40px rgba(52, 211, 153, 0.1)' }}>
                        <div className='flex items-center justify-start mt-4 mb-10' >
                            <span className='p-3 md:p-4 bg-white rounded-full'><DesktopMacSharp className="text-5xl md:text-[42px] text-emerald-400"/></span>
                            <h1 className='ml-4 md:ml-6 text-3xl md:text-4xl font-semibold text-white'>Back-End Development</h1>
                        </div>
                        <p className='break-words mb-4 text-gray-400 text-base md:text-lg leading-8'>
